"""
cypher/airdrop_runner.py — Multi-wallet airdrop task orchestrator.
...
logger = logging.getLogger("cypher.runner")
...
class RunState:
    def __init__(self, db_path: Path = Path.home() / ".cypher" / "runs.db"):
...
if __name__ == "__main__":
    ...
    wm = WalletManager(master_password=os.environ["CYPHER_MASTER_PW"])
    wallet_refs = [
