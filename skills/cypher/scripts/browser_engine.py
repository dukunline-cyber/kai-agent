"""
cypher/browser_engine.py — Browser Automation (v4.0)
...
DEFAULT_PROFILE = Path(os.environ.get("CYPHER_BROWSER_PROFILE", "~/.cypher/browser-profile")).expanduser()
...
class BrowserAgent:
    ...
    async def screenshot(self, path: str = "/tmp/cypher_page.png") -> str:
