# Cypher Crypto Agent — Skill

Multi-chain crypto + Web3 agent toolkit untuk Cypher AI Agent.
...
# Notifier (optional)
export CYPHER_TG_BOT_TOKEN="..."
export CYPHER_TG_CHAT_ID="..."
export CYPHER_DISCORD_WEBHOOK="..."
```

## Prinsip Operasi Cypher
...
Pakai `copy_trade_arkham()` — poll Arkham transfer history wallet whale, mirror buy ukuran kecil di Cypher wallet (filter out stablecoin & low-value).
